...
description = "rgit hosts git: remotes, users and keys, path ACL, fast-forward merge requests, shell CI, and SemVer 2.0 / Conventional Commits by default."
weight = 11
...
Shorter map: [What is Rabun Git?](/docs/what-it-is/).
